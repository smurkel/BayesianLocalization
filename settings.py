...
MAP_REFINE_ITERATIONS = 50 # amount of iterations performed to refine the initial estimate for a.
MAP_REFINE_FRAMES_USED = 10 # the number of on-state frames used in the map refinement. More frmaes = better result, but longer computation.
MAP_PROPOSAL_XY_SIGMA = 0.3
MAP_PROPOSAL_RADIUS_SIGMA = 0.1
MAP_PROPOSAL_INTENSITY_SIGMA = 50.0

MAP_REFINE_XY_SIGMA = 0.1
MAP_REFINE_RADIUS_SIGMA = 0.1
MAP_REFINE_INTENSITY_SIGMA = 50.0

NUMERICAL_DERIVATIVE_DELTA = [0.001, 0.001, 0.01, 10]
MARKOV_SAMPLES = 10
HESSIAN_FRAMES_USED = 5
############
### DATA ###
############
"""PSF parameters"""
PSF_INTENSITY_MU = 1000
PSF_INTENSITY_LOGNORM_S = 0.2
